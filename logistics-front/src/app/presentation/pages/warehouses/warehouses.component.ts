...
export class WarehousesComponent implements OnInit {
  ...
  openCreate(): void {
    ...
    this.getModal('warehouseModal').then(m => m.show());
  }
  ...
  save(): void {
    ...
    op$.subscribe({
      next: () => { this.saving.set(false); this.getModal('warehouseModal').then(m => m.hide()); this.load(); },
  ...
  confirmDelete(w: Warehouse): void {
    ...
    this.getModal('warehouseDeleteModal').then(m => m.show());
  }
  ...
  deleteConfirmed(): void {
    ...
    this.deleteUC.execute(id).subscribe({
      next: () => { this.getModal('warehouseDeleteModal').then(m => m.hide()); this.load(); },
